...
from utils.pybullet_tools.utils import connect, get_pose, is_placement, point_from_pose, \
    ...
    get_distance, LockRenderer, get_min_limit, get_max_limit, has_gui, WorldSaver, set_camera_pose, wait_if_gui, add_line, SEPARATOR
...
def main_simple_version(body_list, env, custom_limits={}, use_gui=False, partial=False, defer=False):
    ...
    with Profiler():
        with LockRenderer(lock=True):
            solution = solve(pddlstream_problem, algorithm='adaptive', unit_costs=True,
