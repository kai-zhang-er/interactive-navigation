...
class NAMOENV(gym.Env):
    ...
    def __init__(self, init_pos=(-4,-1,0),
        ...
        self.global_map=np.zeros((500,500), dtype=np.uint8)
    ...
    def _get_large_small_maps(self, pos):
        ...
        ratio=self.global_map.shape[0]/80.0
        large_rgb_map[int(self.goal_image_pos[1]/ratio), int(self.goal_image_pos[0]/ratio), :]=np.array([255, 255, 255])
