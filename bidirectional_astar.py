...
class BidirectionalAStarPlanner:
    ...
    def __init__(self, occupancy_map, resolution, rr):
        """
        ...
        self.max_x, self.max_y = occupancy_map.shape[0], occupancy_map.shape[1]
        self.x_width, self.y_width, self.obstacle_map = 1, 1, None
        self.resolution = resolution
        self.rr = rr
        self.obstacle_map=occupancy_map
    ...
    def planning(self, sx, sy, gx, gy):
        ...
        open_set_A.setdefault(self.calc_grid_index(start_node), start_node)
        open_set_B.setdefault(self.calc_grid_index(goal_node), goal_node)
...
def main():
    ...
    occupancy_map=cv2.imread("floor_plan_small.png", 0)//240
    plt.imshow(occupancy_map)
    bidir_a_star = BidirectionalAStarPlanner(occupancy_map, grid_size, robot_radius)
